                                    ...
                                    <tbody class="text-capitalize">
                                        ...
                                        <tr class="text-capitalize">
                                            ...
                                            <td class="d-flex justify-content-center">
                                                <a href="{{ URL::to('assets/dist/img/barangay-permits/'.$barangay_permit->barangayPermitImage) }}" 
                                                    target="_blank" rel="noopener noreferrer">
                                                    <img alt="Valid Barangay Permit" class="profile-user-img img-fluid img-square"
                                                    src="{{ URL::to('assets/dist/img/barangay-permits/'.$barangay_permit->barangayPermitImage) }}" />
                                                </a>
                                            </td>
                                        </tr>
                                        @endforeach
