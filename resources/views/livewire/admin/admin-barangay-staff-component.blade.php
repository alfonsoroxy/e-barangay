    ...
    <div class="container">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">List of Barangay Staff</h1>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">List of Barangay Staff</h3>
                            </div>
                            <div class="card-body">
                                <table id="example1" class="table table-responsive table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-capitalize">
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="{{ route('admin.admin-update-barangay-staff', 
                                                        [ 'user_id' => $user->id ]) }}" 
                                                        rel="noopener" class="btn btn-warning">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <a href="#" rel="noopener" class="btn btn-danger" 
                                                        onclick="confirm('Are you sure, You want do delete this Barangay Staff? ') || 
                                                        event.stopImmediatePropagation()" wire:click.prevent="deleteStaff({{ $user->id }})">
