                                    ...
                                    <tbody class="text-capitalize">
                                        ...
                                        <tr class="text-capitalize">
                                            ...
                                            <td class="d-flex justify-content-center">
                                                <a href="{{ asset('assets/dist/img/bherts/'.$bhert->bhertImage) }}" 
                                                    target="_blank" rel="noopener noreferrer">
                                                    <img alt="Valid BHERT" class="profile-user-img img-fluid img-square"
                                                    src="{{ asset('assets/dist/img/bherts/'.$bhert->bhertImage) }}" />
                                                </a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input id="bhertImage" type="file"
                                                class="form-control @error('bhertImage') is-invalid @enderror" name="bhertImage"
                                                value="{{ old('bhertImage') }}" required autocomplete="bhertImage" 
                                                wire:model="bhertImage">
