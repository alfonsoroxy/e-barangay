@section('title', 'Update Barangay Staff')
    ...
    <div class="container">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Update Barangay Staff</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('admin.admin-barangay-staff') }}">List of Barangay Staff</a>
                            </li>
                            <li class="breadcrumb-item active">
                                Update Barangay Staff
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            <div class="card-header">
                              <h3 class="card-title">Update Barangay Staff</h3>
                            </div>
                            <form wire:submit.prevent="updateStaff" wire:loading.attr="disabled">@csrf
